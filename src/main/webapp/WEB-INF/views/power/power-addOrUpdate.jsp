    ...
    <body>
                ...
                <form class="layui-form">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="power" name="power" required="" lay-verify="required"
                          autocomplete="off" placeholder="请输入权限名" value="${power.power}" class="layui-input">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label class="layui-form-label"><span class="x-red">*</span>状态</label>
                      <div class="layui-input-block">
                          <input type="radio" name="status" value="1" lay-skin="primary" title="可用" checked>
        ...
        <script>
            ...
            layui.use(['form'],function() {
                let form = layui.form;
                if(status){
                    let rs=$('input[name="status"]');//获取所有的状态单选框
                    for(let i=0;i<rs.length;i++){
                        let value=rs[i].value;//获取每个单选框的value值
                        rs[i].checked=value==status;//单选框的值和当前权限状态值一致则直接选中
                    }
                    //调用layui渲染表单
                    form.render();
                }
