...
<html class="x-admin-sm">
                        ...
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="power" placeholder="请输入权限名" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
    ...
    <script type="text/html" id="statusTpl">
        <input type = "checkbox" name = "status" disabled value = "{{d.status}}" lay-skin = "switch" lay-text = "可用|禁用" lay-filter = "status" {{ d.status == 1 ? 'checked': ''}} />
    </script>
    ...
    <script type="text/javascript">
        layui.use(['table','form'], function() {
            ...
            table.on('toolbar(tableList)',function(obj) {
                if(obj.event=="add"){
                    xadmin.open("权限信息","power/toUpdate",400,300,false);
                }
            });
            /*监听表格内工具栏*/
            table.on('tool(tableList)',function (obj){
                if(obj.event=="update"){
                    xadmin.open("权限信息","power/toUpdate?id="+obj.data.id,400,300,false);
                }
                if(obj.event=="delete"){
