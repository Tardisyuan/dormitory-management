...
<%--                            按照条件进行搜索--%>
                            ...
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="mname" placeholder="请输入专业名" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
    ...
    <script type="text/html" id="statusTpl">
        <input type = "checkbox" name = "mstatus" disabled value = "{{d.mstatus}}" lay-skin = "switch" lay-text = "可用|禁用" lay-filter = "mstatus" {{ d.mstatus == 1 ? 'checked': ''}} >
    </script>
    ...
    <script type="text/javascript">
        layui.use(['table','form'], function() {
            ...
            table.on('toolbar(tableList)',function(obj) {
                if(obj.event=="add"){
                    xadmin.open("专业信息","major/toUpdate",450,400,false);
                }
            });
            /*监听表格内工具栏*/
            table.on('tool(tableList)',function (obj){
                if(obj.event=="update"){
                    xadmin.open("专业信息","major/toUpdate?mid="+obj.data.mid,450,400,false);
                }
                if(obj.event=="delete"){
            ...
            table.render({
                ...
                url:"major/list",/*远程加载JSON数据*/
                cols:[[/*设置列*/
                    {field: 'mid',title:'专业编号'},
                    {field: 'mname',title: '专业名称'},
                    {field: 'collegename',title: '所在学院'},
                    {field: 'mstatus',title: '状态',templet:'#statusTpl'},
